...
faults | String | The list of faults found with a given address match. Each fault contains the nature of the fault, the address property affected, and the fault penalty. Here is a [complete list of faults]().
